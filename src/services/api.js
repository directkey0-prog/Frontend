...
const dummyProperties = [
  {
    ...
    property_category: 'apartment_type',
    apartment_sub_type: 'duplex',
  ...
  },
  {
    ...
    property_category: 'apartment_type',
    apartment_sub_type: 'semi_detached',
  ...
  {
    id: '16',
    property_name: 'Prime 800sqm Plot in Lekki Phase 2',
    description: 'A rare opportunity to acquire a properly documented 800sqm dry land in the fast-developing Lekki Phase 2. C of O available. Fenced on three sides. Perfect for residential development.',
    property_type: 'Land',
    ...
    amenities: [],
    property_images: [
      { image_url: 'https://picsum.photos/seed/land1a/800/600' },
      { image_url: 'https://picsum.photos/seed/land1b/800/600' },
    ],
    views_count: 88,
    created_at: '2026-01-15T09:00:00.000Z',
    users: { full_name: 'DirectKey Admin', email: 'admin@directkey.com', phone_number: '+2349012345678', whatsapp: '+2349012345678' },
    landlord_contacts: { full_name: 'DirectKey Admin', email: 'admin@directkey.com', phone_number: '+2349012345678', whatsapp: '+2349012345678' },
    added_by: 'admin',
  },
  {
    id: '17',
    property_name: '600sqm Residential Land in Gwarimpa, Abuja',
    description: 'Well-located 600 square metre residential plot in Gwarimpa Estate, Abuja. Gazette and Survey Plan available. Located in a peaceful estate close to schools, churches, and shops.',
    property_type: 'Land',
    property_category: 'land',
    monthly_rent: 0,
    price_per_year: 18000000,
    ...
    bathrooms: 0,
    state: 'Abuja',
    local_government: 'Abuja Municipal',
    area: 'Gwarimpa',
    status: 'approved',
    featured: false,
    amenities: [],
    property_images: [
      { image_url: 'https://picsum.photos/seed/land2a/800/600' },
      { image_url: 'https://picsum.photos/seed/land2b/800/600' },
    ],
    views_count: 43,
  ...
  {
    id: '18',
    property_name: 'Luxury 2-Bedroom Shortlet in Victoria Island',
    description: 'Fully furnished 2-bedroom shortlet apartment on Victoria Island. Features high-speed WiFi, Smart TV, air conditioning in all rooms, a fully equipped kitchen, and stunning city views. Daily cleaning and 24/7 concierge available.',
    ...
    status: 'approved',
    featured: true,
    amenities: ['Furnished', 'Internet', '24hr Security', 'Electricity', 'Water Supply', 'Parking Space', 'Smart Home', 'CCTV'],
    property_images: [
      { image_url: 'https://picsum.photos/seed/short1a/800/600' },
      { image_url: 'https://picsum.photos/seed/short1b/800/600' },
      { image_url: 'https://picsum.photos/seed/short1c/800/600' },
    ],
    views_count: 174,
  ...
  {
    id: '19',
    property_name: 'Executive 1-Bedroom Shortlet in Wuse 2, Abuja',
    description: 'Elegant 1-bedroom executive shortlet in the heart of Wuse 2. Features Netflix, high-speed internet, modern kitchen, and fully air-conditioned rooms. Ideal for business travellers. Minimum 2-night stay.',
    property_type: 'Shortlet',
    property_category: 'shortlet',
    monthly_rent: 0,
    price_per_year: 0,
    ...
    status: 'approved',
    featured: false,
    amenities: ['Furnished', 'Internet', 'Electricity', 'Water Supply', '24hr Security', 'Parking Space'],
    property_images: [
      { image_url: 'https://picsum.photos/seed/short2a/800/600' },
      { image_url: 'https://picsum.photos/seed/short2b/800/600' },
    ],
    views_count: 92,
  ...
  {
    id: '20',
    property_name: 'Grand Event Hall in Victoria Island',
    description: 'A world-class event hall in the heart of Victoria Island, capable of hosting up to 600 guests. Features a fully equipped stage, state-of-the-art sound and lighting systems, professional catering services, and ample parking. Ideal for weddings, corporate events, and galas.',
    property_type: 'Event Hall',
    property_category: 'event_hall',
    monthly_rent: 0,
    price_per_year: 0,
    price_per_night: 0,
    ...
    status: 'approved',
    featured: true,
    amenities: ['AC', 'Sound System', 'Projector/Screen', 'Stage', 'Generator', 'Parking Space', 'Security', 'Wi-Fi', 'LED Lighting', 'Tables & Chairs', 'Catering', 'Bar Area'],
    property_images: [
      { image_url: 'https://picsum.photos/seed/hall1a/800/600' },
      { image_url: 'https://picsum.photos/seed/hall1b/800/600' },
      { image_url: 'https://picsum.photos/seed/hall1c/800/600' },
    ],
    views_count: 134,
  ...
  {
    id: '21',
    property_name: 'Abuja Event Centre in Wuse 2',
    description: 'A versatile event centre in Wuse 2, Abuja, accommodating up to 400 guests. Equipped with modern audio-visual equipment, dedicated bridal suites, and outdoor garden space for cocktail receptions.',
    property_type: 'Event Hall',
    property_category: 'event_hall',
    monthly_rent: 0,
    price_per_year: 0,
    ...
    status: 'approved',
    featured: false,
    amenities: ['AC', 'Sound System', 'Stage', 'Generator', 'Parking Space', 'Security', 'Wi-Fi', 'Tables & Chairs', 'LED Lighting', 'CCTV', 'Changing Room', 'Outdoor Space'],
    property_images: [
      { image_url: 'https://picsum.photos/seed/hall2a/800/600' },
      { image_url: 'https://picsum.photos/seed/hall2b/800/600' },
    ],
    views_count: 67,
  ...
  {
    id: '22',
    property_name: 'Premium Office Space in Victoria Island',
    description: 'A modern 3-room office space on the 4th floor of a prestigious building on Adeola Odeku Street, Victoria Island. Features include 24/7 power supply, high-speed fibre internet, central air conditioning, dedicated parking spaces, and a professional reception area. Ideal for small to medium businesses, law firms, and corporate offices.',
    ...
    amenities: [],
    property_images: [
      { image_url: 'https://picsum.photos/seed/office1a/800/600' },
      { image_url: 'https://picsum.photos/seed/office1b/800/600' },
    ],
    views_count: 45,
...
export const getProperties = async (filters = {}) => {
  ...
  if (filters.category) {
    if (filters.category === 'apartment_type') {
      results = results.filter((p) => p.property_category === 'apartment_type');
    } else {
      results = results.filter((p) => p.property_category === filters.category);
    }
  }

  if (filters.sub_type) {
    results = results.filter((p) => p.apartment_sub_type === filters.sub_type);
  }
...
const dummyTestimonials = [
  {
    ...
    customer_title: 'Tenant',
    customer_location: 'Lekki, Lagos',
  ...
  },
  {
    ...
    customer_title: 'Tenant',
    customer_location: 'Ikeja, Lagos',
    testimonial_text: 'I was skeptical at first, but the digital key fee is totally worth it. Got a verified landlord contact and the apartment was exactly as listed.',
    rating: 5,
    image_url: null,
  },
  {
    id: '3',
    customer_name: 'Tunde Fashola',
    customer_title: 'Landlord',
    customer_location: 'Abeokuta, Ogun State',
    testimonial_text: 'As a landlord in Abeokuta, DirectKey brings me serious tenants only. No more time wasters. My properties get rented faster now.',
    rating: 4,
    image_url: null,
  },
  {
    ...
    customer_title: 'Tenant',
    customer_location: 'Surulere, Lagos',
    testimonial_text: 'Found a beautiful 3-bedroom duplex in Surulere through DirectKey. The process was smooth and transparent from start to finish.',
    rating: 5,
    image_url: null,
  },
  {
    id: '5',
    customer_name: 'Chukwuemeka Eze',
    customer_title: 'Landlord',
    customer_location: 'Asaba, Delta State',
    testimonial_text: 'Listing my properties in Asaba on DirectKey has been great for business. The admin team reviews everything quickly and my listings go live fast.',
    rating: 5,
    image_url: null,
  },
  {
    ...
    testimonial_text: 'Needed a shortlet in VI for a project. DirectKey had great options and getting the landlord contact was instant. Highly recommend!',
    rating: 5,
    image_url: null,
  },
];
